...
public class Smart extends Character {
     ...
     */
    public Smart(int x, int y, int imgNum, BlockBool[][] matrixBool, BlockNum[][] matrixNum,
    ...
    public void setSprite() throws FileNotFoundException {
        ...
        for (int i = 0; i < 9; i++) {
            sprite.add(new Image(new FileInputStream("src/SmartImages/Smart" + i + ".png")));
        }
    }
    ...
    public void derecha(BlockNum block) {
        ...
        for (int k = numBlock.getB(), y = 0; k < numBlock.getD(); k++, y++) {
            try {
                if (y == 8) {
                    y = 0;
                }
    ...
    public void arriba(BlockNum block) {
        ...
        h=0;
        for (int k = numBlock.getC() - 80, y = 0; k >= numBlock.getA() - 80; k--, y++) {
    ...
    public void abajo(BlockNum block) {
        ...
        x = ((numBlock.getB() + numBlock.getD()) / 2) - 38;
        h=0;
        for (int k = numBlock.getA(), y = 0; k < numBlock.getC(); k++, y++) {
            try {
                if (y == 8) {
                    y = 0;
                }
    ...
    public void izquierda(BlockNum block) {
        ...
        h=0;
        for (int k = numBlock.getD() - 66, y = 0; k > numBlock.getB() - 66; k--, y++) {
